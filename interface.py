...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.instructionimagelabel.setPixmap(QtGui.QPixmap("instructions.png"))
        ...
        self.GithubLogo.setPixmap(QtGui.QPixmap("icon.png"))
    ...
    def Enterbuttonclicked(self,savedornot):#this function is added manually too
        try:
            if savedornot==False:#this will only run if cameranumbersaved file has some value
                ...
                eyemouse=eyetracking.eye_mouse(camerainput,cameracheck,aspectratio169check,illumnation)
                eyemouse.eyetrack()
            else:
